...
description: Learn about the JavaScript Trivia API
image: /banner.png
---
...
---
## API Endpoint
The API endpoint is: [`https://api.javascript-trivia.com/`]()
...
* **`answer options`:** Object. The keys are a question label, usually A-D, and the value is the answer text.
* **`correct answer`:** String. Single letter corresponing to the the correct key of the answer options. 
